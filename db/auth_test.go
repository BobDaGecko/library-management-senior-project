...
func TestSetFirstNameValid(t *testing.T) {
	user := User{}
	err := user.SetFirstName("Alvar")
	if err != nil {
		t.Fatalf("first name valid: unexpected error: %v", err)
	}
}
...
func TestSetFirstNameEmpty(t *testing.T) {
	...
	if err == nil {
		t.Fatalf("first name empty: expected error, got nil")
	}
}
...
func TestSetFirstNameTooLong(t *testing.T) {
	...
	if err == nil {
		t.Fatalf("first name too long: expected error, got nil")
	}
}

func TestSetLastNameValid(t *testing.T) {
	user := User{}
	err := user.SetLastName("Kandikatla")
	if err != nil {
		t.Fatalf("last name valid: unexpected error: %v", err)
	}
}
...
func TestSetLastNameEmpty(t *testing.T) {
	...
	if err == nil {
		t.Fatalf("last name empty: expected error, got nil")
	}
}
...
func TestSetLastNameTooLong(t *testing.T) {
	...
	if err == nil {
		t.Fatalf("last name too long: expected error, got nil")
	}
}
...
func TestSecretStrengthValid(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("secret valid: unexpected error: %v", err)
	}
}
...
func TestSecretStrengthMissingUpper(t *testing.T) {
	err := TestSecretStrength("password1!")
	if err == nil {
		t.Fatalf("secret missing upper: expected error, got nil")
	}
}
...
func TestSecretStrengthMissingLower(t *testing.T) {
	err := TestSecretStrength("PASSWORD1!")
	if err == nil {
		t.Fatalf("secret missing lower: expected error, got nil")
	}
}
...
func TestSecretStrengthMissingDigit(t *testing.T) {
	...
	if err == nil {
		t.Fatalf("secret missing digit: expected error, got nil")
	}
}
...
func TestSecretStrengthMissingSymbol(t *testing.T) {
	err := TestSecretStrength("Password1")
	if err == nil {
		t.Fatalf("secret missing symbol: expected error, got nil")
	}
}
...
func TestSecretStrengthTooShort(t *testing.T) {
	...
	if err == nil {
		t.Fatalf("secret too short: expected error, got nil")
	}
}
...
func TestSecretStrengthTooLong(t *testing.T) {
	...
	if err == nil {
		t.Fatalf("secret too long: expected error, got nil")
	}
}
...
func TestValidateJWT(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("jwt valid: unexpected error: %v", err)
	}
	if partial.ID != user.ID.String() {
		t.Fatalf("jwt valid: expected user ID %s, got %s", user.ID.String(), partial.ID)
	}
}
...
func TestValidateJWTInvalid(t *testing.T) {
	...
	if err == nil {
		t.Fatalf("jwt invalid: expected error, got nil")
	}
}
